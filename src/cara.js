...
➸ *${prefix}tts*
Suara google contoh : ${prefix}tts id Hallo ITS
➸ *${prefix}toimg*
Reply sticker yang mau dijadiin image
➸ *${prefix}nulis*
Untuk menulis dibuku
➸ *${prefix}stalkig*
Stalking instagram contoh : ${prefix}stalkig iamITS
➸ *${prefix}quotes*
Random quotes
➸ *${prefix}bikinquote*
Membuat quotes contoh : ${prefix}bikinquote Kamu gay & ITS
➸ *${prefix}play*
...
➸ *${prefix}pornhub*
Membuat logo, contoh : ${prefix}pornhub ITS & Hub
